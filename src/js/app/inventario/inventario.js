...
MyService.data.luz=null; 
    ...
    $http.get('http://52.33.127.122:1345/articulo/?idEstablecimiento='+MyService.data.idEstablecimiento).then(function (resp) {
...
$scope.openPeso = function (item) {
  ...
  $scope.selectItem = function(item){    
    ...
    //  $http.get('http://52.33.127.122:1345/peso/?idArticulo='+identificador).then(function (resp) {
  ...
  $scope.deleteItem = function(item){
    $http.delete('http://52.33.127.122:1345/articulo/'+item.id , item)
  ...
  $scope.deleteArticulo = function(articulo){
    $http.delete('http://52.33.127.122:1345/articulo/'+articulo.id , articulo)
  ...
  articuloAct.estado=item.estado;
   articuloAct.control=false;
    ...
    if (MyService.data.idenArticulo){
      $scope.pop4();
      $http.put('http://52.33.127.122:1345/articulo/'+MyService.data.idenArticulo , articuloAct)
    }
    else {
      $scope.pop3();;
      $http.post('http://52.33.127.122:1345/articulo/', articuloAct)
    }
    $http.get('http://52.33.127.122:1345/categoria/?idEstablecimiento='+MyService.data.idEstablecimiento).then(function (resp) {
      $scope.categorias = resp.data.results;
    });
