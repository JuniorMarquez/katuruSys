...
// };
 ...
 $scope.cargaArticulos = function(){
  ...
  $scope.openEntradaInsumo = function (item) {
    var identificador=item.id;
    MyService.data.identificador = identificador;
      var modalInstance = $modal.open({
        templateUrl: 'modalEntradaInsumo.html',
        controller: 'ModalInstanceCtrl',
        size: 'sm',
        resolve: {
           dato: function () {
    ...
    $scope.calculoExistenciaInsumos(identificador);
  };
  ...
  $scope.openSalida = function (item) {
   ...
   $scope.openSalidaInsumo = function (item) {
    var identificador=item.id;
    MyService.data.identificador = identificador;
      var modalInstance = $modal.open({
        templateUrl: 'modalSalidaInsumo.html',
        controller: 'ModalInstanceCtrl',
        size: 'sm',
        resolve: {
           dato: function () {
